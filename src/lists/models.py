...
#: **The money models moved to `money/models.py` on September 2, 2026** --
#: AccountKind, Account, BalanceReading, MoneyCategory, Direction, BillSeries
#: and Bill, in one contiguous block that had sat between `Item` and
#: `ChecklistStep`. Their tables did not move and are still `lists_*`; see
#: `money/models.py` for why, and `money/migrations/0001_initial` for how.
